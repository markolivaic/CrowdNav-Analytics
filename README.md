...
_Figure 2: Simulation of discrete detection impulses transforming into a continuous density field. Left: Raw detection matrix. Center: Smoothed Gaussian field (σ = 8). Right: 3D Topology view of density peaks._
